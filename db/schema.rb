...
ActiveRecord::Schema.define(version: 20161223012803) do
  ...
  create_table "gmov_distpaches", force: true do |t|
    ...
    t.string   "status"
    t.decimal  "distpached_quantity", precision: 18, scale: 0
    t.decimal  "pending_distpach",    precision: 18, scale: 0
    t.decimal  "sale_check_quantity", precision: 18, scale: 0
  end
